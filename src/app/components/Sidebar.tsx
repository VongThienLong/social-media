...
function SidebarComponent({ children }: SidebarComponentProps) {
  return (
    <div className="flex w-full h-screen">
      ...
      <div className="fixed top-0 left-0 h-full bg-gray-100 shadow-md md:block items-center transition-width duration-300 hidden overflow-y-auto">
      ...
      {/* Main Content */}
      <div className="flex flex-grow flex-col mt-[4rem] md:ml-20 md:mt-0 overflow-auto">
